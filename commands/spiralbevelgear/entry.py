...
GEAR_TYPE = 'SpiralBevelGear'
CMD_ID = f'{config.COMPANY_NAME}_{config.ADDIN_NAME}_{GEAR_TYPE}_cmdDialog'
CMD_NAME = 'Spiral Bevel Gear Generator'
CMD_Description = 'Spiral Bevel Gear Generator (tooth-trace preview)'
...
def command_created(args: adsk.core.CommandCreatedEventArgs):
    ...
    geargen.SpiralBevelGearCommandInputsConfigurator.configure(args.command)
...
def command_execute(args: adsk.core.CommandEventArgs):
    ...
    try:
        ...
        g = geargen.SpiralBevelGearGenerator(design)
        g.generate(inputs)
    except:
